from flask import render_template, send_file, jsonify, Flask
import config

app = config.connex_app
app.add_api(config.basedir / "swagger.yml", options={"swagger_ui": False})
...
def endpoints():
    return jsonify(
        {
            "characters": "https://www.archerapi.com/api/characters",
